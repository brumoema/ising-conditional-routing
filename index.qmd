...
![Cumulative regret in Fixed Context mode. From left to right: IID, Correlated, and Regime Shift scenarios.](docs/experiments/synthetic_data_files/figure-html/cell-17-output-2.png)
...
![Cumulative regret in Random Context mode. From left to right: IID, Correlated, and Regime Shift scenarios.](docs/experiments/synthetic_data_files/figure-html/cell-18-output-2.png)
